<x-layout>
            ...
            <div class="mt-16">
                <h1 class="text-gray-100 uppercase text-center text-2xl font-bold mb-8">Users Eloquent query</h1>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                    <a href="{{route('users.bad')}}"
                       class="scale-100 p-6 bg-gray-800/50 bg-gradient-to-bl from-gray-700/50 via-transparent ring-1 ring-inset ring-white/5 rounded-lg
                        ...
                        <div>
                            ...
                            <h2 class="mt-6 text-xl font-semibold text-white">Bad</h2>


                        </div>

                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                             class="self-end shrink-0 stroke-red-500 w-6 h-6 mx-6">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                  d="M4.5 12h15m0 0l-6.75-6.75M19.5 12l-6.75 6.75"/>
                        </svg>
                    </a>

                    <a href="{{route('users.better')}}"
                       class="scale-100 p-6 bg-gray-800/50 bg-gradient-to-bl from-gray-700/50 via-transparent ring-1 ring-inset ring-white/5 rounded-lg
                        flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                        <div>
                            <div
                            ...
                            <h2 class="mt-6 text-xl font-semibold text-white">Better</h2>
                    ...
                    <a href="{{route('users.good')}}"
                       class="scale-100 p-6 bg-gray-800/50 bg-gradient-to-bl from-gray-700/50 via-transparent ring-1 ring-inset ring-white/5 rounded-lg
                        ...
                        <div>
                            ...
                            <h2 class="mt-6 text-xl font-semibold text-white">Good</h2>
                        </div>
                    ...
                    flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                        <div>
                            ...
                            <h2 class="mt-6 text-xl font-semibold text-white">Best</h2>
